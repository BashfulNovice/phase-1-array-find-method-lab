...
//sadReality =  [ { result: "N/A" }, { result: "N/A" }, { result: "N/A" } ]
...
function superbowlWin(array) {
    let winElement = array.find(didTheyWin);
    //console.log(typeof(winElement));
    if (typeof(winElement) === 'object') {
        winElement = winElement.year;
    } else {}
    return winElement;
}
